<?php
include("session.php");
$exp_fetched = mysqli_query($con, "SELECT expenses.*, users.firstname as shared_user_name, IFNULL(shared_expenses.user_id, 'N/A') as shared_user_id, IFNULL(shared_expenses.amount, 'N/A') as shared_amount FROM expenses LEFT JOIN shared_expenses ON expenses.expense_id = shared_expenses.expense_id LEFT JOIN users ON shared_expenses.user_id = users.user_id WHERE expenses.user_id = '$userid'");
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th>Shared With User ID</th>
                                    <th>Shared Name</th>
                                    <th>Amount They Should Pay</th>
                            ...
                            while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['shared_user_id']; ?></td>
                                    <td><?php echo $row['shared_user_name']; ?></td>
